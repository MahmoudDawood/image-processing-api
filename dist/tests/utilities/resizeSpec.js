...
describe("Tests resize asynchronus function", function () {
    ...
    it("Creates thumb -distenation folder- if it doens't exist", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    _a.sent();
                    // Assert
                    expect(fs_1.default.existsSync(targetPath)).toEqual(true);
                    return [2 /*return*/];
            }
        });
    }); });
